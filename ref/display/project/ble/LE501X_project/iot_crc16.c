...
// calculate CRC16 on a packet unsigned short Modbus_Crc16Cal(const void *ptr, int length) {
//     register unsigned short c1, c2;
//     register unsigned short crc = 0xffff;
//     // initial value
//     register unsigned char *ptr_pkt_hdr = (unsigned char *)ptr;
//     c2 = length;
//     for (c1 = 0; c1 < c2; c1++) {
