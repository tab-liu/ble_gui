...
#define CONFIG_EXAMPLE_ETH_SPI_HOST	SPI2_HOST//1
...
//SPI GPIO,DTU
#define SPI_ETH_MOSI_GPIO_PIN 			15
#define SPI_ETH_MISO_GPIO_PIN 			7
#define SPI_ETH_SCLK_GPIO_PIN 			6
#define SPI_ETH_CS_GPIO_PIN 			16
#define SPI_ETH_INT_GPIO_PIN 			4//（中断输入）
#define SPI_ETH_RST_GPIO_PIN 			5//（复位输入）
...
//tbd CONFIG_EXAMPLE_ETH_SPI_PHY_ADDR ##num;                
#define INIT_SPI_ETH_MODULE_CONFIG(eth_module_config, num)                                      \
    do {                                                                                        \
        eth_module_config[num].spi_cs_gpio = SPI_ETH_CS_GPIO_PIN;           \
        eth_module_config[num].int_gpio = SPI_ETH_INT_GPIO_PIN;             \
        eth_module_config[num].phy_reset_gpio = SPI_ETH_RST_GPIO_PIN;   \
...
static esp_err_t spi_bus_init(void)
{
    ...
    spi_bus_config_t buscfg = {
        .miso_io_num = SPI_ETH_MISO_GPIO_PIN,
        .mosi_io_num = SPI_ETH_MOSI_GPIO_PIN,
        .sclk_io_num = SPI_ETH_SCLK_GPIO_PIN,
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
    };
...
esp_err_t example_eth_init(esp_eth_handle_t *eth_handles_out[], uint8_t *eth_cnt_out)
{
    ...
    eth_handles = iot_calloc((SPI_ETHERNETS_NUM + INTERNAL_ETHERNETS_NUM) * sizeof(esp_eth_handle_t));
